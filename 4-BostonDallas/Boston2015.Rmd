...
boston <- subset.data.frame(US2015, US2015$CITY == "BOSTON" & US2015$STATE == "MA")
dallas <- subset.data.frame(US2015, US2015$CITY == "DALLAS" | US2015$CITY == "FORT WORTH" & US2015$STATE == "TX")
```
...
```{r}
#Source a function I've written for a ggplot histogram
source('~/Documents/Coe College/Spellman 2018/R/gammahist.R')

bostonzip <- gammahist(bostongammas, gamma)
ggsave("boston15.jpg", width = 16, height = 9)

dallaszip <- gammahist(dallasgammas, gamma)
ggsave("dallas15.jpg", width = 16, height = 9)

```

That chunk replaced this code:
